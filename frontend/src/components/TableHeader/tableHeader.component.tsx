    ...
    <>
      <thead className="bg-gray-50 dark:bg-gray-800">
        <tr>
          ...
          <th scope="col" className="px-3.5 py-3.5 text-sm font-normal text-left rtl:text-right text-gray-500 dark:text-gray-400">Edit</th>
          <th scope="col" className="px-3.5 py-3.5 text-sm font-normal text-left rtl:text-right text-red-500 dark:text-red-400">Delete</th>
        </tr>
      </thead>
    </>
  )
